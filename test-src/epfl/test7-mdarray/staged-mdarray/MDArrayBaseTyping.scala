...
trait MDArrayBaseTyping {
  ...
  abstract class TypingConstraint(val prereq: Boolean) {
    override def toString = getConstraintString(this)
    // TODO: Understand why I get "java.lang.ClassCastException" when using this
    //override def toString = (if (prereq) "PRE:  " else "POST: ") + getConstraintString(this)
  }
  ...
  private def getConstraintString(constraint: TypingConstraint): String = {
    ...
    // TODO: Understand why I get
    // java.lang.ClassCastException: scala.virtualization.lms.epfl.test7.MDArrayBaseTyping$$anonfun$scala$virtualization$lms$epfl$test7$MDArrayBaseTyping$$getConstraintString$1 cannot be cast to java.lang.Boolean
    //	at scala.runtime.BoxesRunTime.unboxToBoolean(Unknown Source)
	  //  at scala.virtualization.lms.epfl.test7.MDArrayBaseTyping$class.scala$virtualization$lms$epfl$test7$MDArrayBaseTyping$$getConstraintString(MDArrayBaseTyping.scala:62)
	  //  at scala.virtualization.lms.epfl.test7.MDArrayBaseTyping$TypingConstraint.toString(MDArrayBaseTyping.scala:35)
