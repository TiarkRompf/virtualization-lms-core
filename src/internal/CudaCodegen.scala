...
trait CudaCodegen extends GPUCodegen with CppHostTransfer with CudaDeviceTransfer {
  ...
  override def initializeGenerator(buildDir:String, args: Array[String], _analysisResults: MMap[String,Any]): Unit = {
    ...
    headerStream.print("#define Hostbool bool\n")
    headerStream.print("#define HostCHAR CHAR\n")
    headerStream.print("#define Hostshort short\n")
    headerStream.print("#define Hostint int\n")
    headerStream.print("#define Hostlong long\n")
    headerStream.print("#define Hostfloat float\n")
    headerStream.print("#define Hostdouble double\n")
