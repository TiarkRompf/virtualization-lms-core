...
trait StructExp extends BaseExp {
  ...
  def struct[T:Manifest](tag: List[String], elems: Map[String,Rep[Any]])(implicit ctx: SourceContext): Rep[T] = Struct[T](tag, elems)
  
  def field[T:Manifest](struct: Rep[Any], index: String)(implicit ctx: SourceContext): Rep[T] = Field[T](struct, index)
