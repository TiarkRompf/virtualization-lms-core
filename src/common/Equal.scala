...
trait Equal extends Base with VariablesStub with OverloadHack {
  ...
  def infix_==[A,B](a: Rep[A], b: Rep[B])(implicit o: Overloaded1, mA: Manifest[A], mB: Manifest[B]) : Rep[Boolean] = equals(a,b)
  def infix_==[A,B](a: Rep[A], b: Var[B])(implicit o: Overloaded2, mA: Manifest[A], mB: Manifest[B]) : Rep[Boolean] = equals(a, b)
  def infix_==[A,B](a: Var[A], b: Rep[B])(implicit o: Overloaded3, mA: Manifest[A], mB: Manifest[B]) : Rep[Boolean] = equals(a, b)
  def infix_==[A,B](a: Rep[A], b: B)(implicit o: Overloaded4, mA: Manifest[A], mB: Manifest[B]): Rep[Boolean] = equals(a, b)
  def infix_==[A,B](a: A, b: Rep[B])(implicit o: Overloaded5, mA: Manifest[A], mB: Manifest[B]): Rep[Boolean] = equals(a, b)
  def infix_==[A,B](a: Var[A], b: B)(implicit o: Overloaded6, mA: Manifest[A], mB: Manifest[B]): Rep[Boolean] = equals(a, b)
  def infix_==[A,B](a: A, b: Var[B])(implicit o: Overloaded7, mA: Manifest[A], mB: Manifest[B]): Rep[Boolean] = equals(a, b)
  def infix_==[A,B](a: Var[A], b: Var[B])(implicit o: Overloaded8, mA: Manifest[A], mB: Manifest[B]) : Rep[Boolean] = equals(a,b)
  // TODO: this will probably never get called due to original, equally specific ==
  def infix_==[A:Manifest,B:Manifest](a: A, b: B) : Rep[Boolean] = equals(a,b)
...
trait EqualBridge extends BaseExp {
...
trait EqualBridgeOpt extends EqualBridge {
...
trait EqualExp extends Equal with EqualBridge with VariablesStubExp
trait EqualExpOpt extends EqualExp with EqualBridgeOpt
