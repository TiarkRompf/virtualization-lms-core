...
trait ArrayMutation extends ArrayLoops {
  ...
  def infix_update[T:TypeRep](a: Rep[Array[T]], i: Rep[Int], x: Rep[T]): Rep[Unit]

  def infix_mutable[T:TypeRep](a: Rep[Array[T]]): Rep[Array[T]]
  def infix_clone[T:TypeRep](a: Rep[Array[T]]): Rep[Array[T]]
...
trait ArrayMutationExp extends ArrayMutation with ArrayLoopsExp {
  ...
  def infix_update[T:TypeRep](a: Rep[Array[T]], i: Rep[Int], x: Rep[T]) = reflectWrite(a)(ArrayUpdate(a,i,x))

  def infix_mutable[T:TypeRep](a: Rep[Array[T]]) = reflectMutable(ArrayMutable(a))
  def infix_clone[T:TypeRep](a: Rep[Array[T]]) = ArrayClone(a)
